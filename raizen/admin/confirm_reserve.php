	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<?php
					$query = $conn->query("SELECT * FROM `transaction` NATURAL JOIN `guest` NATURAL JOIN `tour` WHERE `transaction_id` = '$_REQUEST[transaction_id]'") or die(mysqli_error());
				...
				<form method = "POST" enctype = "multipart/form-data" action = "save_form.php?transaction_id=<?php echo $fetch['transaction_id']?>">
					...
					<div class = "form-inline" style = "float:left;">
						...
						<br />
						<input type = "text" value = "<?php echo $fetch['tour_type']?>" class = "form-control" size = "20" disabled = "disabled"/>
					</div>
					<div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Tour No.</label>
						<br />
						<input type = "number" min = "0" max = "999" name = "tour_no" class = "form-control" required = "required"/>
					</div>
					<div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Days</label>
						<br />
					...
					<div class = "form-inline" style = "float:left; margin-left:20px;">
						<label>Extra Participant</label>
						<br />
						<input type = "number" min = "0" max = "99" name = "extra_participant" class = "form-control"/>
					</div>
					<div class = "form-inline" style = "float:left; margin-left:20px;">
						<label style = "color:#ff0000;">*Extra participant cost 500</label>
					</div>
					<br style = "clear:both;"/>
					<br />
